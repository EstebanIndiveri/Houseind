...
import { Container, Typography, Grid, TextField, Button,Avatar, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions } from '@material-ui/core';
...
class LoginMobile extends Component {
    ...
    verificarNumero=e=>{
        ...
        firebase.auth.signInWithPhoneNumber(this.state.usuario.telefono,appVerificacion).then(codigoEnviado=>{
            this.setState({
                dialogAbierto:true,
    ...
    loginConTelefono=()=>{
        ...
        firebase.auth.signInAndRetrieveDataWithCredential(credencial).then(authUser=>{
            ...
            <Container maxWidth="xs">
                ...
                <Dialog open={this.state.dialogAbierto} onClose={()=>{this.setState({dialogAbierto:false})}}>
                    ...
                    <DialogContent>
                        ...
                        <TextField autoFocus magin='dense' name='codigo' fullWidth value={this.state.usuario.codigo} onChange={this.onChange}/>
                    </DialogContent>
                    <DialogActions>

                        <Button color="secondary" onClick={()=>{this.setState({dialogAbierto:false})}}>
                            Cancelar
                        </Button>
...
export default consumerFirebase(LoginMobile);
